QT.waylandclient_private.VERSION = 5.12.9
...
QT.waylandclient_private.includes = $$QT_MODULE_INCLUDE_BASE/QtWaylandClient/5.12.9 $$QT_MODULE_INCLUDE_BASE/QtWaylandClient/5.12.9/QtWaylandClient
...
QT.waylandclient_private.disabled_features = wayland-brcm wayland-client-texture-sharing-experimental wayland-libhybris-egl-server-buffer wayland-vulkan-server-buffer
